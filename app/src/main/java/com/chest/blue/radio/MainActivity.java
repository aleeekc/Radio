...
public class MainActivity extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loadingIcon = getResources().getDrawable(R.drawable.control_loading_icon);
        ...
        setVolumeControlStream(AudioManager.STREAM_MUSIC); /* Create an Intent to launch an Activity for the tab (to be reused)*/
        intent = new Intent().setClass(this, StreamHD1.class); /* Initialize a TabSpec for each tab and add it to the TabHost*/
        spec = tabHost.newTabSpec("streamHD1").setIndicator(this.getString(R.string.tab_name_HD1), res.getDrawable(R.drawable.ic_tab_hdone)).setContent(intent);
        tabHost.addTab(spec);
        ...
        spec = tabHost.newTabSpec("streamHD2").setIndicator(this.getString(R.string.tab_name_HD2), res.getDrawable(R.drawable.ic_tab_hdtwo)).setContent(intent);
        tabHost.addTab(spec);
        ...
        */
        ...
        /* Initialize a TabSpec for each tab and add it to the TabHost
        *
        intent = new Intent().setClass(this, PodcastList.class);
        spec =*tabHost *.
        newTabSpec("podcastList").setIndicator(this.getString(R.string *.tab_name_podcasts), res.getDrawable(R.drawable.ic_tab_stream))*.
        setContent(intent);
        tabHost.addTab(spec);*/ /* Initialize a TabSpec for each tab and add it to the TabHost*/

        intent = new Intent().setClass(this, InfoScreen.class);
        spec = tabHost.newTabSpec("infoScreen").setIndicator(this.getString(R.string.tab_name_info), res.getDrawable(R.drawable.ic_tab_options)).setContent(intent);
        tabHost.addTab(spec);
        ...
        tabHost.setOnTabChangedListener(new OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                if (tabId == "streamHD1") container.setBackgroundDrawable(backgroundHD1);
                if (tabId == "streamHD2") container.setBackgroundDrawable(backgroundHD2);
                if (tabId == "podcastList") container.setBackgroundDrawable(backgroundHD1);
                if (tabId == "infoScreen") container.setBackgroundDrawable(backgroundHD1);
            }
        });
        notifyBGPlay(); /* loadAd(); adHandler.postDelayed(loadAd, 5 * 1000);*/
    }

    @SuppressWarnings("null")
    @Override
    protected void onPause() {
        playIcon = getResources().getDrawable(R.drawable.control_play_icon); /* bgPlay = infoScreen.bgPlay;*/
